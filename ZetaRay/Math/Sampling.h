...
namespace ZetaRay::Math
{
	...
	void BuildAliasTableUnnormalized(Vector<float, 32>&& probs, Vector<AliasTableEntry>& ret) noexcept;
	void BuildAliasTableNormalized(Vector<float>&& probs, Vector<AliasTableEntry>& ret) noexcept;
}
