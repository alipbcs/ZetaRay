...
void MeshContainer::RebuildBuffers() noexcept
{
	...
	m_vertexBuffer = App::GetRenderer().GetGpuMemory().GetDefaultHeapBufferAndInit(SceneRenderer::SCENE_VERTEX_BUFFER, vbSizeInBytes,
	...
	m_indexBuffer = App::GetRenderer().GetGpuMemory().GetDefaultHeapBufferAndInit(SceneRenderer::SCENE_INDEX_BUFFER, ibSizeInBytes,
