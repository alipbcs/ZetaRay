...
struct cbReduction
{
	...
	uint_ DispatchDimXFirstPass;

	//
	// Second Pass
	//

	uint_ NumGroupsInFirstPass;		// e.g. 1920 * 1080 / (THREAD_GROUP_SIZE_X_FIRST * THREAD_GROUP_SIZE_Y_FIRST)
	...
	uint_ NumToProcessPerThreadSecondPass;	// ceil(NumGroupsInFirstPass * 1024) / 1024
};
