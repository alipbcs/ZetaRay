...
namespace ZetaRay
{
	...
	namespace RenderPass
	{
		...
		private:
			...
			// parameter callbacks
			void DepthMapExpCallback(const ParamVariant& p) noexcept;
			void VoxelGridNearZCallback(const ParamVariant& p) noexcept;
			void VoxelGridFarZCallback(const ParamVariant& p) noexcept;
