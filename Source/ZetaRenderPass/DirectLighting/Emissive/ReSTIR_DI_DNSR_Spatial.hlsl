...
void main(uint3 DTid : SV_DispatchThreadID, uint3 Gid : SV_GroupID, uint3 GTid : SV_GroupThreadID)
{
	...
	const uint2 swizzledDTid = Common::SwizzleThreadGroup(DTid, Gid, GTid, uint16_t2(RESTIR_DI_DNSR_SPATIAL_GROUP_DIM_X, RESTIR_DI_DNSR_SPATIAL_GROUP_DIM_Y),
		g_local.DispatchDimX, RESTIR_DI_DNSR_SPATIAL_TILE_WIDTH, RESTIR_DI_DNSR_SPATIAL_LOG2_TILE_WIDTH, g_local.NumGroupsInTile);
#else
