...
void main(uint3 DTid : SV_DispatchThreadID, uint3 Gid : SV_GroupID, uint3 GTid : SV_GroupThreadID)
{
    ...
    float3 filteredDiffuse = FilterDiffuse(swizzledDTid, normal, z_view, flags.metallic, mr.y, posW, rng);
    float3 filteredSpecular = FilterSpecular(swizzledDTid, normal, z_view, flags.metallic, mr.y, posW, baseColor, rng);
