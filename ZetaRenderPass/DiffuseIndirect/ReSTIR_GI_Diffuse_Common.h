...
#define RGI_DIFF_TEMPORAL_GROUP_DIM_X 16u
#define RGI_DIFF_TEMPORAL_GROUP_DIM_Y 8u

#define RGI_DIFF_TEMPORAL_TILE_WIDTH 16
#define RGI_DIFF_TEMPORAL_LOG2_TILE_WIDTH 4

#define RGI_DIFF_SPATIAL_GROUP_DIM_X 32u
#define RGI_DIFF_SPATIAL_GROUP_DIM_Y 32u

#define RGI_DIFF_SPATIAL_TILE_WIDTH 16
#define RGI_DIFF_SPATIAL_LOG2_TILE_WIDTH 4

#define DiffuseDNSR_TEMPORAL_THREAD_GROUP_SIZE_X 16u
#define DiffuseDNSR_TEMPORAL_THREAD_GROUP_SIZE_Y 16u

#define DiffuseDNSR_SPATIAL_THREAD_GROUP_SIZE_X 32u
#define DiffuseDNSR_SPATIAL_THREAD_GROUP_SIZE_Y 16u
