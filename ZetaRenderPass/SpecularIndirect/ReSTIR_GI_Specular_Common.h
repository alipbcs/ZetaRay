...
#define RGI_SPEC_TEMPORAL_GROUP_DIM_X 8u
#define RGI_SPEC_TEMPORAL_GROUP_DIM_Y 8u

#define RGI_SPEC_TEMPORAL_TILE_WIDTH 16
#define RGI_SPEC_TEMPORAL_LOG2_TILE_WIDTH 4

#define RGI_SPEC_SPATIAL_GROUP_DIM_X 32u
#define RGI_SPEC_SPATIAL_GROUP_DIM_Y 32u

#define RGI_SPEC_SPATIAL_TILE_WIDTH 16
#define RGI_SPEC_SPATIAL_LOG2_TILE_WIDTH 4

#define SPECULAR_DNSR_GROUP_DIM_X 8u
#define SPECULAR_DNSR_GROUP_DIM_Y 8u
